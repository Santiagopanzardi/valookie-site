            ...
            <div className="space-y-8">
              ...
              <div className="rounded-2xl overflow-hidden border relative">
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
                  <a
                    href="https://www.google.com/maps/dir/?api=1&destination=Valookie+-+Cookies+estilo+New+York+en+Mataró&destination_place_id=ChIJAykKzii1pBIRxGpQ-Lj_r4k"
                    target="_blank"
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+34623589294" className="text-primary hover:underline">
                        +34 623 589 294
                      </a>
                    </div>
                  </div>
